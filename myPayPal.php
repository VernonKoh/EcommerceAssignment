...
$PayPalApiUsername 	= 'sb-tyq4i29349228_api1.business.example.com'; 		//PayPal API Username
$PayPalApiPassword 	= 'LU3J6L7GZ79QYY3W'; 		//Paypal API password
$PayPalApiSignature = 'AU-e1EfQy4BwPYgFRU434E6PUStLAd5KfdVe8GNQhLvRIwy-lrKDfpFU'; 		//Paypal API Signature
$PayPalCurrencyCode = 'SGD'; //Paypal Currency Code
//URL to redirect to after PayPal has complete the online payment
$PayPalReturnURL 	= 'http://localhost:8081/EcommerceAssignment/checkoutProcess.php'; 
//URL to redirect to if user clicks cancel                
$PayPalCancelURL 	= 'http://localhost:8081/EcommerceAssignment/shoppingCart.php'; 
