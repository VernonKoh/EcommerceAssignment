...
if($_POST) //Post Data received from Shopping cart page.
{
    ...
    $total = $_SESSION["SubTotal"] + $_SESSION["Tax"] + $_SESSION["ShipCharge"] + $_SESSION["DeliveryCharge"];
	...
	$padata = '&CURRENCYCODE=' . urlencode($PayPalCurrencyCode) .
        ...
        '&PAYMENTREQUEST_0_HANDLINGAMT=' . urlencode($_SESSION["DeliveryCharge"]) .  // Include the delivery charge in handling amount
...
// Debugging: Check if $_SESSION["Items"] is set
echo "<pre>";
